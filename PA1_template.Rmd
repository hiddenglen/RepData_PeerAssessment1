...
activity <- read.csv("activity_data/activity.csv", stringsAsFactors=FALSE)
str(activity)
summary(activity)
```

use lubridate package and convert interval to hour:minute format
...
```
barplot of  the total number of steps taken per day as a 
